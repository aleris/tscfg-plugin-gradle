...
class ClassGenerator(val task: GenerateTscfgTask) {
  ...
  fun generate(configSource: ConfigSource): String {
    ...
    val amendedCode = amendCode(code, configFile.name, task.addGeneratedAnnotation.get())
    return amendedCode
  }
   ...
   * @param configSpecFileName the name of the tscfg spec file to be included in the header.
   * @param includeGeneratedAnnotation whether to include the generated annotation.
   */
  private fun amendCode(code: String, configSpecFileName: String, includeGeneratedAnnotation: Boolean): String {
...
comments = "This class is generated by the TscgfPlugin")"""
    ...
    val codeWithHeader = "/* Generated with `${task.name}` Gradle task */\n" +
        "/* Do not edit this file manually, change spec in `$configSpecFileName` */\n\n" +
        "$codeProcessed\n"
